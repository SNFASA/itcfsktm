...
import type { EventData, EventEligibility, EventStatus } from '@/lib/public/EventsData'
        ...
        <div className="text-center py-16">
          ...
          {(searchTerm || selectedEligibility || selectedStatus) && (
            <button
              ...
              className="px-6 py-3 text-primary hover:text-white hover:bg-primary transition-all duration-300 rounded-xl border border-primary font-semibold"
            >
              Clear all filters
            </button>
          )}
